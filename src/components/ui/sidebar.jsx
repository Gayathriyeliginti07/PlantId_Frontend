...
// The rest of the subcomponents (SidebarGroupAction, SidebarGroupContent, SidebarMenu, SidebarMenuItem, SidebarMenuButton, SidebarMenuAction, SidebarMenuBadge, SidebarMenuSkeleton, SidebarMenuSub, SidebarMenuSubItem, SidebarMenuSubButton) can be converted in the same way:  
// 1. Remove TypeScript types.  
// 2. Keep Slot usage for asChild.  
// 3. Keep cn class concatenation.  
// 4. Keep all props spread {...props}.
